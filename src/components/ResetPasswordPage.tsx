...
export function ResetPasswordPage() {
  ...
  if (isChecking) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#3F76FF]/5 via-[#00C5E9]/5 to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center p-3 md:p-4">
        <div className="w-full max-w-md">
          <div className="flex flex-col items-center space-y-4">
            <GoworkLogo variant="full" size="large" />
            <div className="w-8 h-8 border-2 border-[#3F76FF]/30 border-t-[#3F76FF] rounded-full animate-spin" />
            <p className="text-slate-600 dark:text-slate-400">Validando sessão...</p>
          </div>
        </div>
      </div>
    );
        ...
        <Card className="border-2 shadow-xl">
          <CardHeader className="pb-4 border-b">
            <div className="flex items-center gap-2 justify-center mb-2">
              <Key className="w-5 h-5 text-[#3F76FF]" />
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-[#3F76FF] hover:bg-[#3F76FF]/90 text-white"
                disabled={isLoading}
              >
                {isLoading ? (
