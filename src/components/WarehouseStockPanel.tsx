              ...
              <div key={stock.id} className="border rounded-lg p-3 bg-white">
                <div className="flex items-start justify-between gap-2 mb-2">
                  <div className="flex items-start gap-2 flex-1 min-w-0">
                    <Package className="h-4 w-4 text-[#3F76FF] flex-shrink-0 mt-0.5" />
                  ...
                  <TableRow key={stock.id}>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Package className="h-4 w-4 text-[#3F76FF]" />
                        <div>
              ...
              <Card>
                <CardContent className="pt-4 sm:pt-6 pb-3 sm:pb-6">
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl font-semibold text-[#3F76FF]">{regularStock.length}</div>
