      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <QrCode className="h-5 w-5 text-[#3F76FF]" />
          ...
          {!scannedCode ? (
            <div className="space-y-3">
              ...
              {!isScanning ? (
                ...
                <div className="space-y-2">
                  <div className="relative rounded-lg overflow-hidden border-2 border-[#3F76FF]">
                    <video
                      ref={videoRef}
                      className="w-full"
                      playsInline
                    ...
                    <div className="absolute inset-0 border-4 border-transparent"
                         style={{
                           borderImage: 'linear-gradient(45deg, #3F76FF, #00C5E9) 1',
                         }}
                    >
